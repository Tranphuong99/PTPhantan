...
namespace Nosql
{
    public partial class HoSo : Form
    {
        ...
        {
            dataGridView1.DataSource = readToTable("QUANLITHONGTINNHANVIEN", "NUT");
        }
        ...
        {
            var collection = db.GetCollection<BsonDocument>("NUT");
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                dataTable.Rows[index][6] = textBox5.Text;
                dataTable.Rows[index][7] = textBox6.Text;
